...
public class StarModelUpdater {
    ...
    public static FactTable sendStarModelUpdatesToDirectory(DirectoryApi directoryApi, Map<String, String> correctedDiagnoses, StarModelInput starModelInput, int minDonors, int maxFacts) {
        ...
        try {
            ...
            logger.info("sendStarModelUpdatesToDirectory: TTTTTTTTTTTTTTTTTTTTTTTTTTT 1 starModelInputData.getFactCount(): " + factTable.getFactCount());
            ...
            logger.info("sendStarModelUpdatesToDirectory: TTTTTTTTTTTTTTTTTTTTTTTTTTT after creation, fact count: " + factTable.getFactCount());

            // Apply corrections to ICD 10 diagnoses, to make them compatible with
            // the Directory.
            factTable.applyDiagnosisCorrections(correctedDiagnoses);
            logger.info("sendStarModelUpdatesToDirectory: TTTTTTTTTTTTTTTTTTTTTTTTTTT after diagnosis corrections, fact count: " + factTable.getFactCount());
